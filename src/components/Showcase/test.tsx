...
describe('<Showcase />', () => {
  it('should render the Showcase with Title,  Highlight and Games', () => {
    ...
    expect(
      screen.getByRole('heading', { name: highlightMockItem.title })
    ).toBeInTheDocument()
  ...
  it('should render without title', () => {
    renderWithTheme(
      <Showcase highlight={highlightMockItem} games={gameCardSliderMockItems} />
    )
  ...
  it('should render without highlight', () => {
    renderWithTheme(
      <Showcase games={gameCardSliderMockItems} title="Most Popular" />
    )

    expect(
      screen.queryByRole('heading', { name: highlightMockItem.title })
    ).not.toBeInTheDocument()
